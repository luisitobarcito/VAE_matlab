...
encoder.hidden.layers(1).f = hyptan;
encoder.hidden.layers(1).f_prime = hyptan_prime;
...
decoder.hidden.layers(1).f = hyptan;
decoder.hidden.layers(1).f_prime = hyptan_prime;
...
if binary == true
    ...
    decoder.mu.layers(1).f = logistic;
